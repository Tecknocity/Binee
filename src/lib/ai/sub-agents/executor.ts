...
const MAX_SUB_AGENT_ROUNDS = 8; // Allow enough rounds for comprehensive tool coverage
const MAX_SUMMARY_TOKENS = 1500; // Allow thorough summaries with full data points
