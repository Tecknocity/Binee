...
- task_manager: Fetches, searches, creates, updates, moves tasks. Also handles comments on tasks, tags, custom fields, dependencies, task links, time tracking (start/stop timers, log manual time), batch task creation from CSV/file data, and attaching file content to tasks. Use for anything about tasks, deadlines, assignments, workload, team activity, time tracking, task comments, tags, custom fields, task relationships, file imports, or file attachments.
