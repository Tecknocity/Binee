      ...
      <div className="w-full max-w-md px-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#F0F0F0]">
            Get started with <span className="text-[#FF6B35]">Binee</span>
          </h1>
          <p className="text-[#A0A0B8] mt-2">AI-powered workspace intelligence for your team</p>
        </div>
        ...
        <div className="bg-[#1A1A2E]/80 border border-[#2A2A4E] rounded-xl p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#A0A0B8] mb-1.5">
                Full Name
              </label>
              <input
                id="name"
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-[#6B6B80]">
            Free plan includes 10 credits/month. No credit card required.
          </p>
        </div>
      </div>
    </div>
